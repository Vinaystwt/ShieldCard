...
**Confidential corporate spend control — encrypted policy evaluation on Fhenix CoFHE, testnet settlement on Arbitrum Sepolia, verifiable audit packets for anyone.**
...
[![Tests](https://img.shields.io/badge/Tests-131%20passing-4E9B6A?style=flat-square)](#tests)
...
|---|---|---|
| **ShieldCardControlPlane** | [`0xC2fe512fE0A4D0Aa0C7452aC43e76aB9331f9dD2`](https://sepolia.arbiscan.io/address/0xC2fe512fE0A4D0Aa0C7452aC43e76aB9331f9dD2) | Encrypted policy engine, FHE three-tier routing, encrypted dept/pack budgets, vendor compliance, risk bitmap, within-budget attestation, scoped auditor disclosure |
| **ShieldCardSettlement** | [`0x8054d6819fa4B43195353579e9519Dd7bc16223A`](https://sepolia.arbiscan.io/address/0x8054d6819fa4B43195353579e9519Dd7bc16223A) | Multi-approver settlement state machine, hash-chained audit trail, testnet MockUSDC payouts |
| **MockUSDC** | [`0x5d05BE0586DF41eCF920013f81ae04C2e7a724b5`](https://sepolia.arbiscan.io/address/0x5d05BE0586DF41eCF920013f81ae04C2e7a724b5) | Testnet ERC-20 (6 decimals) with permissionless mint + faucet. **Not real money.** |
...
- Core: `0x81Ed...5a9D` (Arbitrum Sepolia, deprecated)
- Tests: ~40 passing
...
- Core: `0x268F...` (Arbitrum Sepolia, deprecated)
- Tests: ~70 passing
...
- Core: `0x81Ed...` (Arbitrum Sepolia, deprecated)
- Settlement: `0x81c2...` (Arbitrum Sepolia, deprecated)
- Tests: ~115 passing
