...
export function EmployeeManagement({
  ...
  async function handleRegister(e: React.FormEvent) {
    e.preventDefault();
    if (!regAddress || regPhase === "awaiting_wallet" || regPhase === "confirming") return;
        ...
        <div className="flex items-center justify-between px-5 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-subtle">Register employees on-chain</p>
            </div>
          </div>
          {expanded ? (
            ...
            <div className="p-5 max-w-sm">
              <form onSubmit={handleRegister} className="flex flex-col gap-3">
                ...
                <button
                  ...
                  style={{
                    background:
                      regPhase === "done" ? "var(--approved-bg)" : "rgba(200,131,63,0.10)",
                    border:
                      regPhase === "done"
                ...
                {(regPhase === "done" || regPhase === "error") && regMsg && (
                  <p
                    className={cn(
                      "text-[11px]",
                      regPhase === "done" ? "text-approved" : "text-denied",
                    )}
                  >
                    {regPhase === "error" && (
